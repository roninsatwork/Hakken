...
| Workflow automation and schedules | `/admin/workflows`, workflow detail, executions, schedules | `convex/workflows.ts`, `convex/workflowRuntime.ts`, `convex/workflowEngine.ts`, `convex/scheduler.ts`, `workflows`, `workflowExecutions`, `workflowExecutionSteps`, `schedules` | `docs/end-user/workflow-automation.md`, `docs/developer/workflow-automation.md`, `docs/developer/workflow-runtime-internals.md` | Complete pair | Keep approval nodes, public triggers, schedule behavior, and runtime internals current. |
