...
| `ai.ts` | assistant response generation, audio transcription, speech synthesis, voice knowledge search, realtime voice session/ticket creation, thread title generation | [Assistant Chat Developer Guide](./assistant-chat.md), [AI Administration Developer Guide](./ai-administration.md), [Spoken Channels](./spoken-channels.md) |
