...
| `chat.ts`, `chatAdmin.ts`, `messageFeedback.ts` | thread/message reads, upload URL generation, thread CRUD, send message, image attachment URLs, assistant message streaming, answer feedback, safety refusal, admin chat thread pagination | [Assistant Chat Developer Guide](./assistant-chat.md), [Photo Actions](./photo-actions.md), [AI Administration Developer Guide](./ai-administration.md) |
...
| `wikiPages.ts`, `wikiActions.ts`, `wikiAsk.ts`, `wikiDistill.ts`, `wikiDistillActions.ts`, `wikiStaff.ts`, `wikiTending.ts`, `wikiTendingActions.ts`, `wikiQuestions.ts`, `wikiContradictionActions.ts`, `wikiFreshness.ts`, `wikiFreshnessActions.ts`, `wikiReviews.ts`, `wikiReviewActions.ts`, `wikiFilingActions.ts`, `wikiFeedback.ts`, `wikiDiary.ts`, `wikiReport.ts`, `wikiRewriteService.ts`, `wikiExam.ts`, `wikiExamActions.ts`, `wikiExamService.ts` | company and platform wiki pages, source notes, distillation, staff agents, tending, open questions, review checkpoints, unanswered demand, diary events, answer context, filing, reports, and wiki exams | [Company Wiki](./company-wiki.md) |
...
| Tools, connectors, widgets, and webhooks | `toolConnectors`, `toolConnectorTestLogs`, `toolConnectorSecretRefs`, `toolConnectorOAuthConnections`, `connectorOAuthTokens`, `mailboxMessages`, `aiTools`, `agentTools`, `widgets`, `webhookDeliveries` | [AI Tools And Connectors](./ai-tools-and-connectors.md), [Gmail Mailbox](./gmail-mailbox.md), [Embedded Widgets](./embedded-widgets.md), [Receptionist Screen](./receptionist-screen.md), [Public API And Webhooks](./public-api-and-webhooks.md) |
