...
| `chat.ts`, `chatAdmin.ts`, `messageFeedback.ts` | thread/message reads, upload URL generation, thread CRUD, send message, assistant message streaming, answer feedback, safety refusal, admin chat thread pagination | [Assistant Chat Developer Guide](./assistant-chat.md), [AI Administration Developer Guide](./ai-administration.md) |
...
| Chat and knowledge services | `chatService.ts`, `chatAdminService.ts`, `knowledgeService.ts`, `knowledgeRetrievalService.ts` | [Assistant Chat Developer Guide](./assistant-chat.md), [AI Administration Developer Guide](./ai-administration.md), [Knowledge Management](./knowledge-management.md) |
...
| Knowledge and chat | `knowledgeDocuments`, `knowledgeChunks`, `knowledgeChunkStats`, `threads`, `messages`, `messageFeedback` | [Knowledge Management](./knowledge-management.md), [Assistant Chat Developer Guide](./assistant-chat.md) |
