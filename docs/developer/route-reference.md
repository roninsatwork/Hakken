...
| `/admin/settings/identity` and `/identity/aesthetics` | Core identity and global aesthetics. | [Platform Operations Settings](../end-user/platform-operations-settings.md), [Platform Operations Settings Developer Guide](./platform-operations-settings.md) |
| `/admin/settings/security` and `/security/retention` | PII masking, and log retention and purges. | [Platform Operations Settings](../end-user/platform-operations-settings.md), [Data Retention And Purges](./data-retention-and-purges.md) |
| `/admin/settings/options`, `/options/self-improvement`, `/options/approvals` | Developer diagnostics, learning switches, agent approval window. | [Platform Operations Settings](../end-user/platform-operations-settings.md), [Self-Improvement Plan](../plans/active/self-improvement-plan.md) |
