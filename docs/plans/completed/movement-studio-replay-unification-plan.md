...
Status: historical unification plan; end-to-end alignment is now controlled by [Movement Definitive Plan](../active/movement-definitive-plan.md). The retired [Replay Studio And Game Studio Runtime Alignment Plan](./replay-game-runtime-alignment-plan.md) remains background only.
