...
- Remaining: step 4 default-profile collapse review (partially done via the unification comments) and the live-path webcam check the runbook requires before client demos. Cross-avatar and instructor-foot proof are now current and revision-stamped in Acceptance gap closure step 6.
