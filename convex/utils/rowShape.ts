...
export const rowShape = {
  billingAccounts: v.object({ ...whole("billingAccounts"), _id: v.id("billingAccounts") }),
  billingCheckouts: v.object({ ...whole("billingCheckouts"), _id: v.id("billingCheckouts") }),
  ...
  agentMemories: v.object({ ...whole("agentMemories"), _id: v.id("agentMemories") }),
  agentToolCalls: v.object({ ...whole("agentToolCalls"), _id: v.id("agentToolCalls") }),
  agentVersions: v.object({ ...whole("agentVersions"), _id: v.id("agentVersions") }),
  agentRunApprovals: v.object({ ...whole("agentRunApprovals"), _id: v.id("agentRunApprovals") }),
  agentRunFeedback: v.object({ ...whole("agentRunFeedback"), _id: v.id("agentRunFeedback") }),
  agentRunSteps: v.object({ ...whole("agentRunSteps"), _id: v.id("agentRunSteps") }),
  agentRuns: v.object({ ...whole("agentRuns"), _id: v.id("agentRuns") }),
  ...
  agentTransactions: v.object({ ...whole("agentTransactions"), _id: v.id("agentTransactions") }),
  arcadeScores: v.object({ ...whole("arcadeScores"), _id: v.id("arcadeScores") }),
  dataMigrations: v.object({ ...whole("dataMigrations"), _id: v.id("dataMigrations") }),
  authEvents: v.object({ ...whole("authEvents"), _id: v.id("authEvents") }),
  knowledgeChunks: v.object({ ...whole("knowledgeChunks"), _id: v.id("knowledgeChunks") }),
  ...
  maintenanceScriptRuns: v.object({ ...whole("maintenanceScriptRuns"), _id: v.id("maintenanceScriptRuns") }),
  mcpServers: v.object({ ...whole("mcpServers"), _id: v.id("mcpServers") }),
