        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <MetricBlock 
              ...
              sub="Ingress/Egress Compute"
              delay={0.1}
            />
            <MetricBlock 
              icon={MessageSquare}
              title="Message Inferences"
              value={(data.aggregates.totalMessages ?? 0).toLocaleString()}
              sub="Total Model Instructions"
              delay={0.2}
            />
            <MetricBlock 
              icon={Users}
                     ...
                     <AreaChart data={data.timeline}>
                       ...
                       <Tooltip 
                         ...
                         formatter={(value: any, name: any) => [
                            ...
                            name === 'cost' ? 'Estimated AI Cost' : 'Workspace Actions'
                         ]}
                       />
                       <Area 
                         yAxisId="left"
               ...
               >
                  <div className="px-6 py-5 border-b border-border-dim bg-background/30 flex flex-col gap-1.5">
                     <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-[14px] font-bold text-foreground">Top Individual Initiators (For this Tenant)</h2>
                     </div>
                  </div>
