...
const TRIGGER = "e.g. 'book a meeting'";
const INSTRUCTION = "Provide explicit instructions for how the AI should react...";
...
describe("EditCompanyRulePage", () => {
  ...
  const show = () =>
    renderWithProviders(<EditCompanyRulePage params={routeParams({ id: COMPANY_ID, ruleId: RULE_ID })} />);
