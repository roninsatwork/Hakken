...
export default async function CompanyAiLayout({ children, params }: CompanyAiLayoutProps) {
  ...
  return (
    <div className="flex flex-col gap-6 w-full 2xl:flex-row 2xl:items-start">
      <AdminRouteSubmenu compactLabel="AI section" label="AI workspace sections" items={items} mode="wideOnly" />
