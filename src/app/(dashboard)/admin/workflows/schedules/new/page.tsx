...
export default function NewSchedulePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.workflowId) {
      setErrorModal("Please search and select a Target Workflow before deploying the schedule.");
      return;
    }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[13px] text-secondary mt-1">Configure an autonomous trigger for a workflow.</p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 flex-1 relative w-full pt-2">
        ...
        <div className="flex items-center justify-end pt-4 border-t border-border-dim mt-2">
           <div className="flex items-center">
             ...
             >
               {isSubmitting ? "Deploying..." : "Deploy Schedule"}
