        ...
        <div className="flex flex-col gap-8">
           <div className="flex flex-col gap-2">
             ...
             <p className="text-[14px] text-secondary leading-relaxed">
               You are about to irreversibly sever this behavioral trigger from the agent's logic engine. The AI will no longer correlate or respond to this specific instruction matrix.
             </p>
