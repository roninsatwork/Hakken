    ...
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 pb-12 w-full max-w-6xl">
      <header className="flex flex-col gap-2 border-b border-border-dim/50 pb-6 w-full mt-2">
        ...
        <p className="text-[14px] text-secondary">
          Live feed of underlying LLM transactions, action dispatches, and token expenditures associated with this Agent.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
         <div className="flex flex-col gap-2 p-5 rounded-[14px] bg-sidebar/40 border border-border-dim/60 shadow-sm relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 text-[12px] font-medium tracking-widest text-muted uppercase">
              <Zap className="w-3.5 h-3.5" /> Total Generations
            </div>
         ...
         <div className="flex flex-col gap-2 p-5 rounded-[14px] bg-sidebar/40 border border-border-dim/60 shadow-sm relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 text-[12px] font-medium tracking-widest text-muted uppercase">
              <Database className="w-3.5 h-3.5" /> Tokens Ingested
            </div>
            <div className="text-3xl font-bold text-foreground font-mono mt-1">
               {stats === undefined ? (
         ...
         <div className="flex flex-col gap-2 p-5 rounded-[14px] bg-sidebar/40 border border-border-dim/60 shadow-sm relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 text-[12px] font-medium tracking-widest text-muted uppercase">
              <TerminalSquare className="w-3.5 h-3.5" /> Total OPEX Cost
            </div>
            <div className="text-3xl font-bold text-foreground font-mono mt-1">
          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="border-b border-border-dim/50 bg-sidebar/40">
                <th className="px-5 py-3.5 text-[11px] font-mono tracking-widest text-muted uppercase">Timestamp</th>
                <th className="px-5 py-3.5 text-[11px] font-mono tracking-widest text-muted uppercase">Transaction Context</th>
                <th className="px-5 py-3.5 text-[11px] font-mono tracking-widest text-muted uppercase">Model Pipeline</th>
                <th className="px-5 py-3.5 text-[11px] font-mono tracking-widest text-muted uppercase text-right">Tokens (In/Out)</th>
                <th className="px-5 py-3.5 text-[11px] font-mono tracking-widest text-muted uppercase text-right">Run Cost</th>
                <th className="px-5 py-3.5 text-[11px] font-mono tracking-widest text-muted uppercase text-right w-[100px]">Status</th>
              </tr>
            </thead>
                  ...
                  <td colSpan={6} className="px-5 py-16 text-center">
                    <div className="flex flex-col items-center justify-center gap-4 w-full">
                       ...
                       <div className="flex flex-col gap-1 items-center">
                          <span className="text-[14px] font-medium text-foreground tracking-wide">No transactions recorded</span>
                          <span className="text-muted text-[12px]">This agent has not executed any AI operations yet.</span>
                       </div>
              ...
              {results.map((tx, idx) => (
                <tr key={tx._id} className="group hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-5 py-4 pr-6 flex justify-end">
                    {tx.status === "SUCCESS" ? (
                       <div className="flex items-center justify-center w-6 h-6 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-500" title="Success">
                          <CheckCircle2 className="w-3.5 h-3.5" />
                       </div>
                    ) : (
                       <div className="flex items-center justify-center w-6 h-6 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-500" title="Failed">
