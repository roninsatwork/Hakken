            ...
            <div className="relative flex flex-col bg-[#1e1e20] border border-white/5 rounded-[32px] p-4 pb-3 shadow-[0_8px_30px_rgb(0,0,0,0.12)] focus-within:bg-[#252528] transition-colors duration-300">
              ...
              <div className="flex items-center justify-between w-full mt-3">
                ...
                <div className="flex items-center gap-1">
                  <button type="button" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/10 text-muted transition-colors">
                    <Plus className="w-5 h-5" />
                  </button>
                  <button type="button" className="h-10 px-4 flex items-center gap-2 rounded-full hover:bg-white/10 text-muted transition-colors">
