...
export function formatBroadCaptureContractPreflight(report) {
  ...
  return [
    ...
    `Support claim status snapshot: ${report.supportClaimStatus ?? "unknown"} (${report.supportClaimSnapshotSource ?? "source unknown"}).`,
    ...
    `Missing broad passed proof cases snapshot: ${formatList(report.missingBroadPassedProofCases)}.`,
    `Missing broad Game target-plan cases snapshot: ${formatList(report.missingBroadGamePlanCases)}.`,
    `Missing broad readable Game cases snapshot: ${formatList(report.missingBroadReadableGameCases)}.`,
